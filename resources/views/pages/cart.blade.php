      ...
      <section class="store-cart">
        <div class="container">
              ...
              <table class="table table-borderless table-cart">
                ...
                <tbody>
                  ...
                  @foreach ($carts as $cart)
                      ...
                      <tr>
                        <td style="width: 25%">
                          @if (Count($cart->product->galleries) > 0)
                        ...
                        <td style="width: 35%">
                          ...
                          <div class="product-subtitle">by{{ $cart->product->user->storename }} </div>
                        </td>
                        <td style="width: 35%">
          ...
          <form action="{{ route('checkout') }}" id="locations" enctype="multipart/form-data" method="POST">
            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="225">
              <div class="col-md-6">
            ...
            <div class="row" data-aos-delay="275" data-aos="fade-up">
              <div class="col-12">
                <hr />
              </div>
              <div class="col-12">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="315">
